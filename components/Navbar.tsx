...
export default function Navbar({ onMenuClick }: NavbarProps) {
    ...
    return (
        <nav className="w-full h-16 bg-[#051424]/80 backdrop-blur-xl border-b border-[#494454]/30 px-4 lg:px-10 flex items-center justify-between shadow-[0_0_20px_0_rgba(208,188,255,0.15)] select-none">
            ...
            <div className="flex items-center gap-4 lg:gap-6">
                ...
                <button
                    className="lg:hidden relative flex items-center justify-center text-[#CBC3D7] hover:text-white transition-colors focus:outline-none"

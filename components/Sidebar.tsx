...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
    return (
        <>
            ...
            <aside
                // className="w-64 bg-[#0D1C2D] border-r border-[#494454]/20 flex flex-col justify-between p-4 h-[calc(100vh-61px)] shadow-[0_8px_10px_-6px_rgba(208,188,255,0.05),0_20px_25px_-5px_rgba(208,188,255,0.05)]"
                className={`
            fixed lg:static inset-y-0 left-0 z-50
            w-64 bg-[#0D1C2D] border-r border-[#494454]/20
            flex flex-col justify-between p-4
            h-[calc(100vh-61px)] lg:h-[calc(100vh-61px)]
            transition-transform duration-300
            ${isOpen ? "translate-x-0 h-full" : "-translate-x-full"}
            lg:translate-x-0
            shadow-[0_8px_10px_-6px_rgba(208,188,255,0.05),0_20px_25px_-5px_rgba(208,188,255,0.05)]
        `}
            >
                <div>
